    ...
    <div class="content flex-column-fluid" id="kt_content">
        <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
            <div class="page-title d-flex flex-column py-1">
                <h1 class="d-flex align-items-center my-1"><span class="text-dark fw-bold fs-1">Masukan</span></h1>
                    ...
                    <form id="form_search" class="w-100">
                        ...
                        <div class="card-title d-flex flex-row align-items-center gap-4">
                            <div class="d-flex align-items-center position-relative gap-6 w-100 w-lg-250px">
                                ...
                                <x-input name="email" prefix="search_" caption="Search Email" class="w-lg-250px ps-12" />
                            </div>
                            <div class="d-flex align-items-center position-relative gap-6 w-100 w-lg-250px">
                                <i class="ki-duotone ki-magnifier fs-3 position-absolute ms-4"><span
                                        class="path1"></span><span class="path2"></span></i>
                                <x-input name="nama" prefix="search_" caption="Search Nama" class="w-lg-250px ps-12" />
                            </div>
...
@push('scripts')
    <script>
        ...
        let selected_page = 1,
            _token = '{{ csrf_token() }}',
            base_url = '{{ route('admin.masukan.index') }}';
